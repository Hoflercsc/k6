...
export default function getDiscussionsHttp() {
  ...
  group("open up discussion 672 Reply 1584", function () {
    sleep(3);
    const url = (`https://lab-load-testing.boardeffect.com/workrooms/8205/discussions/672/discussion_posts/1584`);
    let response = http.get(url);
    console.log("open up discussion 672 Reply > "+response.status)
